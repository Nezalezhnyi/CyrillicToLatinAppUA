...
public class MainApp extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        FXMLLoader rulesFXMLObjectsLoader = new FXMLLoader(getClass().getResource("/rulesResources/RulesChangingScene.fxml")); //
        ...
        Parent rulesSceneRoot = rulesFXMLObjectsLoader.load(); // it saves the information of fxml objects and assigns it to the respective root (root is the object where all fxml objects are located it)
        ...
        RulesChangingController rulesChangingController = rulesFXMLObjectsLoader.getController(); // Gets the RulesSceneController instance
